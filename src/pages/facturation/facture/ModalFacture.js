...
const ModalFacture = (props) => {
  ...
  return (
    <Modal showModal={showModal} setShowModal={setShowModal}>
      ...
      <div className="modalBody"><PrintFacture dossier={dossier} /></div>
      <div className="modalFooter">
        <button
          className="modalBtn"
          onClick={() => {
            let content = ReactDomServer.renderToString(<PrintFacture dossier={dossier} />)
            print(content);
            console.log(content);
          }}
        >
